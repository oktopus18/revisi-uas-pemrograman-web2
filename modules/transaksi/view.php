...
<section class="content-header">
  <h1>
    ...
    <a style="background-color: red;" class="btn btn-primary btn-social pull-center" href="export.php">
      <i style="color: white;" class="fa fa-plus"></i> Print
    </a>
  </h1>
          ...
          <table id="dataTables1" class="table table-bordered table-striped table-hover">
            ...
            while ($data = mysqli_fetch_assoc($query)) { 
              ...
              echo "<tr>
                      ...
                      <td width='110' class='center'>$data[daftar_paket]</td>
