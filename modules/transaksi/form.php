          ...
          <form role="form" class="form-horizontal" method="POST" action="modules/transaksi/proses.php?act=insert" method="POST">
            <div class="box-body">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-5">
                  <input type="text" style="text-transform:uppercase" class="form-control" name="no_hp" autocomplete="off" required>
                </div>
              </div>
          ...
          <form role="form" class="form-horizontal" method="POST" action="modules/transaksi/proses.php?act=update" method="POST">
            <div class="box-body">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label">No hp</label>
                <div class="col-sm-5">
                  <input type="text" style="text-transform:uppercase" class="form-control" name="no_hp" autocomplete="off" value="<?php echo $data['no_hp']; ?>" required>
                </div>
              </div>
