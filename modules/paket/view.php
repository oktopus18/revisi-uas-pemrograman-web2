          ...
          <table id="dataTables1" class="table table-bordered table-striped table-hover">
            ...
            while ($data = mysqli_fetch_assoc($query)) { 
              ...
              echo "<tr>
                      ...
                      <td width='200'>$data[nama_restoran]</td>
                      <td width='100'>$data[daftar_paket]</td>
                      <td width='100' align='right'>Rp. $data[harga].</td>
            ...
            ?>
                          <a data-toggle="tooltip" data-placement="top" title="Hapus" class="btn btn-danger btn-sm" href="modules/paket/proses.php?act=delete&id=<?php echo $data['id_paket'];?>" onclick="return confirm('Anda yakin ingin menghapus <?php echo $data['nama_restoran']; ?> ?');">
